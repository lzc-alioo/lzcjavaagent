...
public class TraceAgent {
    ...
    public static void agentmain(String agentArgs, Instrumentation instrumentation) throws UnsupportedEncodingException {
        ...
        Class classes[] = getMatchedClass(agentArgs, instrumentation);
    ...
    private static Class[] getMatchedClass(String agentArgs, Instrumentation instrumentation) {
...
//                System.out.println("debug:::" + classes[i]);
