...
public class TraceAgent {
    ...
    public static final String LZC_JAVA_AGENT_PATH = "/Users/mac/work/gitstudy/lzcjavaagent/lzc-javaagent-asm3/target/lzc-javaagent-asm3-0.0.1-SNAPSHOT.jar";
    ...
    public static void agentmain(String agentArgs, Instrumentation instrumentation) throws UnsupportedEncodingException {
        try {
            instrumentation.appendToBootstrapClassLoaderSearch(new JarFile(LZC_JAVA_AGENT_PATH));
        } catch (IOException e) {
